document.addEventListener('DOMContentLoaded', () => {
    ...
    const allQuestionsData = [
        ...
        { text: "9.	Estoy preparado para cualquier desastre.", type: 6 }, 
        { text: "16.	Me preocupa la seguridad más que cualquier otra cosa.", type: 6 }, 
        { text: "17.	Pienso mucho en lo que pasará en el futuro.", type: 6 }, 
        { text: "30.	Siempre tengo un plan de lo que haría si las cosas salen mal.", type: 6 }, 
        { text: "37.	Busco relaciones que me ofrezcan algún tipo de protección.", type: 6 },
        { text: "38.	Puedo visualizar claramente lo que podría pasar en el futuro.", type: 6 }, 
        { text: "211.	¿Muchas veces me pregunto si tendré el coraje para hacer algo que debo hacer?", type: 6 },
        { text: "57.	Me siento más cómodo en organizaciones con una jerarquía clara.", type: 6 }, 
        { text: "58.	Tomo medidas para protegerme a mí mismo y a mis seres queridos de cualquier daño.", type: 6 }, 
        { text: "212.	¿Muchas veces me encuentro lleno de dudas?", type: 6 }, 
        { text: "215.	¿Tiendo a actuar debido a un sentido del deber y responsabilidad?", type: 6 }, 
        { text: "79.	Hago alianzas con personas que pueden ayudarme a mantenerme seguro y protegido.", type: 6 }, 
        { text: "220.	¿Prefiero tener las cosas sujetas a un horario en vez de cuando sea ?", type: 6 }, 
        { text: "93.	Es importante para mí entender qué puede salir mal en una situación.", type: 6 }, 
        { text: "100.	Me preocupa proteger lo que tengo", type: 6 },
        { text: "224.	¿Parece preocuparme más que a otras personas el defenderme a mí mismo y mi posición?", type: 6 },
        { text: "113.	¿Parezco preocuparme más que otras personas?", type: 6 },
        { text: "207.	¿La lealtad a un grupo es muy importante para mí?", type: 6 },
        { text: "208.	¿Me cuesta mucho ir en contra de lo que dice la autoridad?", type: 6 },
        { text: "209.	¿Antes de tomar una decisión, busco información adicional para asegurarme que estoy preparado?", type: 6 },
        // Tipo 7 ... (20 preguntas)
        ...
        { text: "P1-T8: Directo, asertivo.", type: 8 }, 
        { text: "P2-T8: Protejo a débiles.", type: 8 }, 
        { text: "P3-T8: Valoro fuerza.", type: 8 }, 
        { text: "P4-T8: Me gusta el control.", type: 8 }, 
        { text: "P5-T8: Intimidante, dominante.", type: 8 }, 
        { text: "P6-T8: Disgusta debilidad.", type: 8 }, 
        { text: "P7-T8: Tomo decisiones rápido.", type: 8 },
        { text: "P8-T8: ...", type: 8 }, 
        { text: "P9-T8: ...", type: 8 }, 
        { text: "P10-T8: ...", type: 8 }, 
        { text: "P11-T8: ...", type: 8 }, 
        ...
        { text: "P1-T9: Busco armonía.", type: 9 }, 
        { text: "P2-T9: Medio fácilmente.", type: 9 }, 
        { text: "P3-T9: Valoro paz.", type: 9 }, 
        { text: "P4-T9: Cuesta identificar mis necesidades.", type: 9 }, 
        { text: "P5-T9: Complaciente.", type: 9 }, 
        { text: "P6-T9: Cómodo en ambiente relajado.", type: 9 }, 
        { text: "P7-T9: Procrastino.", type: 9 },
        { text: "P8-T9: ...", type: 9 }, 
        { text: "P9-T9: ...", type: 9 }, 
        { text: "P10-T9: ...", type: 9 }, 
        { text: "P11-T9: ...", type: 9 }, 
